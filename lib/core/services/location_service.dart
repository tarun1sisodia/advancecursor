...
class LocationService {
  ...
  Future<Position> getCurrentPosition({
    ...
    try {
      ...
      if (permission == LocationPermission.deniedForever) {
        throw LocationServiceError.permanentlyDenied();
      }
  ...
  Future<bool> isWithinRadius({
    ...
    try {
      ...
      throw LocationCalculationError('Error calculating distance: $e');
    }
  }
  ...
  Stream<Position> getPositionStream({
    ...
    try {
      ...
      throw AppError('Error getting position stream: $e');
    }
  }
  ...
  Future<double> calculateDistance({
    ...
    try {
      ...
      _logger.error('Error calculating distance', e);
      throw AppError('Error calculating distance: $e');
    }
  }
  ...
  Future<bool> verifyAttendanceLocation({
    ...
    try {
      ...
      throw AppError('Error verifying attendance location: $e');
    }
  }
