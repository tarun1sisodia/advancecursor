...
import 'package:smart_attendance/core/services/device_binding_service.dart';
...
import 'package:smart_attendance/core/services/wifi_service.dart';
...
class AttendanceVerificationService {
  ...
  Future<bool> verifyAttendance({
    ...
    try {
      ...
      throw AppError.attendanceVerificationError('Error during verification');
    }
  }
