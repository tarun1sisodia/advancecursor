...
class AttendanceRecord {
  ...
  get studentId => null;
  get locationLatitude => null;
  get locationLongitude => null;
  get wifiSSID => null;
  get wifiBSSID => null;
...
class AttendanceLocalDatasource {
  deleteRecord(sessionId, studentId) {}
  
  markRecordAsFailed(sessionId, studentId, String string) {}
  
  getRecord(String sessionId, String studentId) {}
  
  storeOfflineAttendance({required String sessionId, required String studentId, required String studentName, double? locationLatitude, double? locationLongitude, String? wifiSSID, String? wifiBSSID, required String deviceId}) {}
